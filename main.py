...
PROGRAM_VERSION = 'v7.0.0_PRE-63'
PROGRAM_DATE = '14.1.2023  23:11 (UTC+5)'
...
ST_BG          = {THEMES[0]: '#EEEEEE', THEMES[1]: '#222222', THEMES[2]: '#DD1515', THEMES[3]: '#FFEECC'}  # Цвет фона окна
ST_BG_FIELDS   = {THEMES[0]: '#FFFFFF', THEMES[1]: '#171717', THEMES[2]: '#FFAAAA', THEMES[3]: '#EEDDCC'}  # Цвет фона полей ввода

ST_BORDER      = {THEMES[0]: '#222222', THEMES[1]: '#111111', THEMES[2]: '#330000', THEMES[3]: '#443322'}  # Цвет рамок
ST_RELIEF      = {THEMES[0]: 'groove',  THEMES[1]: 'solid',   THEMES[2]: 'groove',  THEMES[3]: 'groove' }  # Стиль рамок

ST_SELECT      = {THEMES[0]: '#AABBBB', THEMES[1]: '#444444', THEMES[2]: '#FF5500', THEMES[3]: '#AABBBB'}  # Цвет выделения текста
ST_HIGHLIGHT   = {THEMES[0]: '#00DD00', THEMES[1]: '#007700', THEMES[2]: '#EEEEEE', THEMES[3]: '#22DD00'}  #

ST_BTN         = {THEMES[0]: '#D0D0D0', THEMES[1]: '#202020', THEMES[2]: '#DD2020', THEMES[3]: '#F0E0D0'}  # Цвет фона обычных кнопок
ST_BTN_SELECT  = {THEMES[0]: '#BABABA', THEMES[1]: '#272727', THEMES[2]: '#DD5020', THEMES[3]: '#DCCBBA'}  # Цвет фона обычных кнопок при нажатии
...
ST_FG_TEXT     = {THEMES[0]: '#222222', THEMES[1]: '#979797', THEMES[2]: '#000000', THEMES[3]: '#443322'}  # Цвет обычного текста
ST_FG_LOGO     = {THEMES[0]: '#FF7200', THEMES[1]: '#803600', THEMES[2]: '#FF7200', THEMES[3]: '#FF8800'}  # Цвет текста логотипа
ST_FG_FOOTER   = {THEMES[0]: '#666666', THEMES[1]: '#666666', THEMES[2]: '#222222', THEMES[3]: '#665544'}  # Цвет текста нижнего колонтитула
