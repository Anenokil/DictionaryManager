...
PROGRAM_VERSION = 'v7.1.26:7'
PROGRAM_DATE = '16.6.2023'
PROGRAM_TIME = '15:13 (UTC+3)'
...
LEARN_VALUES_METHOD = ('Угадывать слово по переводу', 'Угадывать перевод по слову',
                       'Der-Die-Das (для немецкого)', 'Угадывать фразу по переводу',
                       'Угадывать перевод по фразе')  # Варианты метода учёбы
