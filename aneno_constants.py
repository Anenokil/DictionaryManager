...
PROGRAM_VERSION = 'v7.1.62-4'
PROGRAM_DATE = '2024.4.4'
PROGRAM_TIME = '22:48 (UTC+3)'
...
LEARN_VALUES_WORDS = ('Все', 'Преимущ. избранные (рекоменд.)', 'Только избранные', 'Только неотвеченные',
...
PRINT_VALUES_ORDER = ('Сначала старые', 'Сначала новые',
                      ...
                      'Снач. давно не попадавшиеся', 'Снач. недавно попадавшиеся',
